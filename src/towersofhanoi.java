...
public class towersofhanoi {
    public static String[][] directions = {{"", "", "1 2", "1 3"}, {"", "1 1", "1 2", "1 3"}, {"", "2 1", "2 2", "2 3"}, {"", "3 1", "3 2", ""}};
    ...
    public static void move(ArrayList<String> moves, int num, int from, int to) {
        String str = directions[from][to];
        if (num == 1) {
            moves.add(str);
            return;
        }
        int other = 6 - to - from;
        move(moves, num - 1, from, other);
        moves.add(str);
        move(moves, num - 1, other, to);
    }
